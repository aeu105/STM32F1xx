...
/* Last-Modified: Wed, 24 Jun 2020 07:52:21 GMT */
const uint32_t imageLastModified = 1592985141U;
...
static const imageFileItem imageFileTable[19U+1U] = {
  ...
  { 0x90CE4E8AU, &imageFileData[7909U]  },    // "keil.gif"
  { 0xD7FABA9AU, &imageFileData[9047U]  },    // "language.cgi"
  { 0x6314E402U, &imageFileData[9951U]  },    // "lcd.cgi"
  { 0xD1C9C758U, &imageFileData[10887U] },    // "leds.cgi"
  { 0x7049A0E1U, &imageFileData[12871U] },    // "llblue.jpg"
  { 0xA35A02C8U, &imageFileData[15879U] },    // "logo.gif"
  { 0xCEC97D75U, &imageFileData[17666U] },    // "network.cgi"
  { 0x3BDBDB05U, &imageFileData[19213U] },    // "pabb.gif"
  { 0x85C7B8E6U, &imageFileData[19334U] },    // "pg_footer.inc"
  { 0x1D1F9D3EU, &imageFileData[19760U] },    // "pg_header.inc"
  { 0x69E9F01DU, &imageFileData[20808U] },    // "system.cgi"
  { 0x5579E5A7U, &imageFileData[22059U] },    // "tcp.cgi"
  { 0xEEA8CB3DU, &imageFileData[22703U] },    // "xml_http.js"
